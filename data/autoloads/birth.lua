...
newBirthDescriptor {
	...
	desc = {
		'#GOLD#BETA#LAST#',
		'The Fire Elemental.',
		'Asha use the #FF6100#heat#LAST# resource. Most of their talents create it, and it diminishes quickly outside of battle. They get faster and stronger the more heat they have.',
		'#FF6100#Heat#LAST# is unique in that fatigue reduces your gain, instead of increasing your loss.',
		'Their primary stats are Strength, Magic, and Dexterity.',
		'#GOLD#Stat modifiers:',
		'#LIGHT_BLUE# * +5 Strength, +3 Dexterity, -2 Constitution',
	...
	inc_stats = {str = 5, dex = 3, con = -2, mag = 4, wil = -1,},
	power_source = {nature = true,},
	talents_types = {
